...
export default function Header({ hiddenContact, onNavClick }) {
    ...
    <header className="backdrop-blur-md bg-black/40 text-white px-6 py-4 fixed top-0 left-0 w-full z-50 shadow-lg">
      <div className="max-w-7xl mx-auto flex justify-between items-center relative w-full logo-xs">
        ...
        <ul className="hidden md:flex space-x-6">
          <li>
            <a onClick={() => onNavClick('about')} className="cursor-pointer hover:underline">
              {t('about')}
            </a>
          </li>
          <li>
            <a onClick={() => onNavClick('projects')} className="cursor-pointer hover:underline">
              {t('projects')}
            </a>
          </li>
          <li>
            <a onClick={() => onNavClick('skills')} className="cursor-pointer hover:underline">
              {t('skills')}
            </a>
          </li>
          {!hiddenContact && (
            <li>
              <a onClick={() => onNavClick('contact')} className="cursor-pointer hover:underline">
                {t('contact')}
              </a>
            </li>
          )}
